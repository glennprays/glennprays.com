...
### 2. Classification
  ...
  - True Positive (TP): Instance correcly predicted as positive.
  - False Positive (FP): Instance correcly predicted as positive but actually negative.
  - True Negative (TN): Instance correcly predicted as negative.
  - False Negative (FN): Instance correcly predicted as negative but actually positive.
